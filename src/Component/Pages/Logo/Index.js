...
export default function Index() {
  ...
  const LogoListAPI = async () => {
    ...
    try {
      let query = {};
      const apiResponse = await callAPI(apiUrls.logoread, query, "GET");
  ...
  return (
    <>
      <div id="page-container" className="page_contclass">
        <Topbar Title="Delivery Logo" Subtitle="Delivery Logo">
          <Link
            to="#"
            onClick={() => {
              setAction("add");
        ...
        <div className="inner-main-content">
          ...
          <div className="tablecard mb-30">
            <div className="tableheader d-flex align-items-center justify-content-between boderbtn">
              <h2 className="mb-0">Delivery Logo</h2>
            </div>
