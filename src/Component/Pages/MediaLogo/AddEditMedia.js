...
export default function AddEditMedia({ open,
  handleclose,
  LogoListAPI,
  action,
  object, }) {
    ...
    if (!formValid) {
      ...
      try {
        ...
        if (apiResponse?.data?.status === true) {
          ...
          await LogoListAPI();
          handleclose();
          setValue({ image: "", status: "active", name: "", link: "" });
          setImage('')
        } else {
  ...
  useEffect(() => {
    ...
    } else setValue({ image: "", status: "active", name: "" });
  }, [object, action, open]);
  return (
    <>
      <Dialog
            ...
            <div className="modal-header p-0 border-bottom-0 position-relative justify-content-center">
              <div className="modelheading text-center">
                <h1 className="modal-title" id="exampleModalLabel">
                  {action === "add" ? "Add" : "Edit"} Media
                </h1>
                <p>Please enter your Media logo details</p>
              </div>
              <button
                type="button"
              ...
              <form className="formcontmodel mt-4">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-12 mb-3">
                    <label htmlFor="">Media Name *</label>
                    <input type="text" className="form-control" onChange={handleChange}
                      value={value.name}
                      name="name" placeholder='Enter Media Name' />
                    <div className="error">
