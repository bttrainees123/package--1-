...
export default function AddRestaurant({
  ...
  const handleAddition = (tag) => {
    const updatedTags = [...inputs.tags, tag];
    setInputs((prev) => ({ ...prev, tags: updatedTags }));
  };
  ...
  const RegisterRestaurent = async () => {
    try {
      setLoader(true);
      const tagsData = inputs?.tags?.map((item) => item.text);
      const apiResponse = await callAPI(apiUrls.addRestaurant, {}, "POST", {
        ...inputs,
        tags: tagsData,
      });
      setLoader(false);
            ...
            <div className="modal-body px-0 py-4">
              <div className="uploadpicuser">
                <figure className="mb-2">
                  <img
                    src={image ? URL.createObjectURL(image) : "/image/cam.png"}
                    id="img-upload-tag"
                    className="img-fluid"
                    alt=""
                  />
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-12 mb-3">
                    ...
                    <input
                      type="text"
                      className="form-control"
                      value={inputs?.leaderBoardHeading}
