...
export default function Addupdatedriver({ open,
  handleclose,
  handleSubmitApi,
  action,
  object }) {
    ...
    if (!formValid) {
      ...
      try {
        ...
        const apiResponse = await callAPI(
          action === "add"
            ? apiUrls.driverCreate
            : apiUrls.driverUpdate + `/${object._id}`,
          {},
          action === "add"
            ? "POST"
            : "PUT",
        ...
        if (apiResponse?.data?.status === true) {
          ...
          handleSubmitApi();
          handleclose();
          setValue({ status: "active", name: "", email: "", mobileno: "" });
        } else {
  ...
  useEffect(() => {
    ...
    } else setValue({ status: "active", name: "", email: "", mobileno: "" });
  }, [object, action, open]);
            ...
            <div className="modal-header p-0 border-bottom-0 position-relative justify-content-center">
              <div className="modelheading text-center">
                <h1 className="modal-title" id="exampleModalLabel">
                  {action === "add" ? "Add" : "Edit"} Driver
                </h1>
                <p>Please enter your driver details</p>
              </div>
              <button
                type="button"
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-12 mb-3">
                    ...
                    <input type="text" className="form-control" onChange={handleChange}
                      value={value.name}
                      name="name" placeholder='Enter Driver Name' />
                    <div className="error">
                  ...
                  <div className="col-lg-6 col-md-6 col-12 mb-3">
                    ...
                    <input type="text" className="form-control" onChange={handleChange}
                      value={value.email}
                      name="email" placeholder='Enter Driver Email' />
                    <div className="error">
                      {simpleValidator.current.message(
                        "Email",
                        value?.email,
